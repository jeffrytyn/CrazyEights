...
public abstract class Board {
     ...
     *                    the deck
     */
    public Board(int size, int playerHand, int computerHand, String[] ranks, String[] suits, int[] pointValues) {
        cards = new Card[size];
    ...
    public void AddToStack(int k) {
        cards[CompHand] = cards[k];
        cards[k] = deck.deal();
    }
